from mksc2 import eda
from mksc2 import feature
from mksc2 import train
from mksc2.utils.reader import check_config


class Start(object):

    def __init__(self):
        print(">>> Welcome use mksc2 to build a quick model task!")
        self.accepts = {}
    ...
    def _exit(self):
        print(">>> Thank you for use mksc2, exiting...")
        exit()
